...
var pillar1Img, pillar2Img, pillar3Img, pillar4Img;
var food1Img, food2Img, food3Img;
...
function setup() {
  ...
  if (gameState == 0) {
    ...
    playBtn.position(width / 2 - 30, 280);
  ...
  gameOver = createSprite(width / 2, height / 3, 100, 100);
  ...
  restart.position(width / 2 - 30, height / 2 + 50);
...
function draw() {
  ...
  if (gameState == 0.5) {
    ...
    fill('aliceblue');
    textSize(27);
    text("Press 'j' or 'up arrow' key to fly the bird", width / 2 - 215, height / 3 + 50);
  }
  ...
  if (gameState == 2) {
    ...
    text('Food Collected: ' + foodCollection, width / 2 - 116, height / 2 - 20);
    textSize(24);
    fill('black');
    // text('Playtime taken: ' + playtime2 - playtime1, width / 2 - 116, height / 2 + 14);
...
function pillars() {
  if (frameCount % 80 == 0 && gameState == 1 && xyz == 0) {
    ...
    var rand = random([pillar2Img, pillar3Img, pillar4Img]);
...
function foods() {
  if (frameCount % 160 && gameState == 1 && xyz == 0) {
